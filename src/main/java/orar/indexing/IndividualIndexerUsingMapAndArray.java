 ...
 *
 */
public class IndividualIndexerUsingMapAndArray {
	private static IndividualIndexerUsingMapAndArray instance;
	private Map<String, Integer> mapIndividualString2Number;
	private List<String> mapNumber2IndividualString;
	private Integer index;
	private OWLDataFactory owlDataFactory;

	private IndividualIndexerUsingMapAndArray() {
		this.mapIndividualString2Number = new HashMap<String, Integer>();
		this.mapNumber2IndividualString = new ArrayList<>();
		index = -1;
		this.owlDataFactory = OWLManager.getOWLDataFactory();
	}

	public static IndividualIndexerUsingMapAndArray getInstance() {

		if (instance == null) {
			instance = new IndividualIndexerUsingMapAndArray();
		}
		return instance;
	}
	...
	public Integer getIndexOfIndividualString(String individualStringID) {
		...
		if (existingIndex == null) {
			...
			this.mapNumber2IndividualString.add(individualStringID);
			return index;
		}
	...
	public Set<Integer> getAllEncodedIndividuals() {
		...
		for (int i = 0; i < this.mapNumber2IndividualString.size(); i++) {
