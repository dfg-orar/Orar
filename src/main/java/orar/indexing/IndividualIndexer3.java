...
public class IndividualIndexer3 {
	...
	public static IndividualIndexer3 getInstance() {

		if (instance == null) {
			instance = new IndividualIndexer3();
		}
		return instance;
	}
