...
public class ConstructorCollectorInSubClass implements OWLClassExpressionVisitorEx<DLConstructor> {
	...
	public DLConstructor visit(OWLObjectUnionOf ce) {
		...
		return DLConstructor.DISJUNCTION;
	}
	...
	public DLConstructor visit(OWLObjectAllValuesFrom ce) {
		...
		return null; // as it should not occur in horn
	}
