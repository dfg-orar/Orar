...
public abstract class DLLiteExtension_MaterializerTemplate implements Materializer {
	// input & output
	...
	// logging
	private static final Logger logger = Logger.getLogger(DLLiteExtension_MaterializerTemplate.class);
	// shared data
