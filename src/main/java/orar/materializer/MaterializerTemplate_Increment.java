...
public abstract class MaterializerTemplate_Increment implements Materializer {
	// input & output
	...
	// logging
	private static final Logger logger = Logger.getLogger(MaterializerTemplate_Increment.class);
	// shared data
	protected final DataForTransferringEntailmentInterface dataForTransferringEntailments;
	...
	public MaterializerTemplate_Increment(OrarOntology2 normalizedOrarOntology) {
		// input & output
		...
		// shared data
		this.dataForTransferringEntailments = DataForTransferingEntailments_Increment.getInstance();
		...
		this.typeComputor = new BasicTypeComputor_Increment(normalizedOrarOntology);
	...
	public void materialize() {
		...
		Map<IndividualType, Set<Integer>> typeMap2Individuals = this.dataForTransferringEntailments.getMapType_2_Individuals();
		
		this.typeComputor.computeTypes();
		...
		while (updated & !hasStopSignal) {
			...
			this.typeComputor.computeTypeIncrementally(this.individualsHavingNewTypes);
			...
			this.individualsHavingNewTypes.addAll(assertionTransporter.getIndividualsHavingNewAssertions());
