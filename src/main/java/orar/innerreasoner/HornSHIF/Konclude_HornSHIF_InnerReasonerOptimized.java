...
public class Konclude_HornSHIF_InnerReasonerOptimized extends HornSHIF_InnerReasonerTemplateOptimized {
	private int portNumber;
	private ExecuteWatchdog watchdog;
	private static Logger logger = Logger.getLogger(Konclude_HornSHIF_InnerReasonerOptimized.class);
	...
	public Konclude_HornSHIF_InnerReasonerOptimized(OWLOntology owlOntology) {
		super(owlOntology);
	...
	public Konclude_HornSHIF_InnerReasonerOptimized(OWLOntology ontology, int portNumber) {
		super(ontology);
