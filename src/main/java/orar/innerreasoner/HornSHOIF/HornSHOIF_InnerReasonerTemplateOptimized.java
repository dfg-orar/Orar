...
import orar.innerreasoner.InnerReasonerTemplateOptimized;
import orar.util.PrintingHelper;

public abstract class HornSHOIF_InnerReasonerTemplateOptimized extends InnerReasonerTemplateOptimized {
	private Logger logger = Logger.getLogger(HornSHOIF_InnerReasonerTemplateOptimized.class);

	public HornSHOIF_InnerReasonerTemplateOptimized(OWLOntology owlOntology) {
		super(owlOntology);
	}
