 ...
 *
 */
public class JenaStreamRDF2InternalModelTuning extends StreamRDFBase {
	...
	private static final Logger logger = Logger.getLogger(JenaStreamRDF2InternalModelTuning.class);
	...
	public JenaStreamRDF2InternalModelTuning(Set<OWLObjectProperty> definedRoleNames, Set<OWLClass> definedConceptNames,
...
//		String subjectString = this.stringFactory.getString(subject.toString());
//		String objectString = this.stringFactory.getString(object.toString());
