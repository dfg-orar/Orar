 ...
 *
 */
public class RDF4JStreamRDF2InternalModel extends AbstractRDFHandler {
	...
	private static final Logger logger = Logger.getLogger(RDF4JStreamRDF2InternalModel.class);
	...
	public RDF4JStreamRDF2InternalModel(Set<OWLObjectProperty> definedRoleNames, Set<OWLClass> definedConceptNames,
