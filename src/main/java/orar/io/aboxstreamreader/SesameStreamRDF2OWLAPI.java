 ...
 *
 */
public class SesameStreamRDF2OWLAPI extends RDFHandlerBase {
	...
	private static final Logger logger = Logger.getLogger(SesameStreamRDF2OWLAPI.class);
	...
	public SesameStreamRDF2OWLAPI(Set<OWLObjectProperty> definedObjectProperties, Set<OWLClass> definedClasses,
