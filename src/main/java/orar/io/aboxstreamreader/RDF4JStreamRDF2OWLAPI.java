 ...
 *
 */
public class RDF4JStreamRDF2OWLAPI extends AbstractRDFHandler {
	...
	private static final Logger logger = Logger.getLogger(RDF4JStreamRDF2OWLAPI.class);
	...
	public RDF4JStreamRDF2OWLAPI(Set<OWLObjectProperty> definedObjectProperties, Set<OWLClass> definedClasses,
