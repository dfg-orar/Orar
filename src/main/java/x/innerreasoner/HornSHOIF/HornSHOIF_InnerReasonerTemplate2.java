...
import x.innerreasoner.InnerReasonerTemplate;
import x.innerreasoner.InnerReasonerTemplate2;
import x.util.PrintingHelper;

public abstract class HornSHOIF_InnerReasonerTemplate2 extends InnerReasonerTemplate2 {
	private Logger logger = Logger.getLogger(HornSHOIF_InnerReasonerTemplate2.class);

	public HornSHOIF_InnerReasonerTemplate2(OWLOntology owlOntology) {
		super(owlOntology);
	}
